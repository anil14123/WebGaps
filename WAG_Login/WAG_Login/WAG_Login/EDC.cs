...
namespace EDC2
{
    public class EDC
    {
        ...
        public static string Key = "ANILWEBGAPS121212";
        ...
        public  static string DecryptStringFromBytes(byte[] cipherText, byte[] Key)
        {
            ...
            {
                Rfc2898DeriveBytes pdb = new Rfc2898DeriveBytes(Convert.ToBase64String(Key), new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 });
        ...
        public static byte[] EncryptStringToBytes(string plainText, byte[] Key)
        {
            ...
            using (RijndaelManaged rijAlg = new RijndaelManaged())
            {
               ...
               string salt = Convert.ToBase64String(new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 });
