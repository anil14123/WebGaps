...
export module Page {
    ...
    export class PageElementBaseJQ {
        ...
        AddRow(root: JQuery, colClassNames: string, className: string, adjustRow?: impCss.CssClass.AdjustJQ, adjustColumn?: impCss.CssClass.AdjustJQ, beforeAfter?: boolean) {
            ...
            //jQuery(row).prepend("<span class='design-page-row'> "
            //    + "<span class='row-controls'> <span class='design-square-row'>Row</span> <span class='columns-add-text'> <button title='Add row up' class='jq-prev-row btn btn-xs btn-danger'> <span class='up fa fa-caret-square-o-up up-down-icons'></span> +</button> <button title='Add row down' class='jq-next-row btn btn-xs btn-danger'> <span class='down fa fa-caret-square-o-down'></span> +</button>  <span title='Move row left' class='button-move-left btn btn-xs btn-danger fa fa-chevron-left ' style='font-size:xx-smaller; padding:3px;'>  </span> <span title='Move row right' style='font-size:xx-smaller; padding:3px;' class='button-move-right btn btn-xs btn-danger fa fa-chevron-right '></span> </span>  <span class='design-square-row'>Columns</span>  <button title='Add column' class='jq-add-column btn btn-xs btn-danger'>+</button>   </span> "
            //    + "<span class='image-text-other-controls'>  <span title='Select row container' class='design-square-row'>Select Row</span>  <span title='Select column container' class='design-square-column jq-select-column'>Select Column</span> <span title='Move object left' class='button-move-left btn btn-xs btn-danger fa fa-chevron-left ' style='font-size:xx-smaller; padding:3px;'>  </span> <span title='Move object right' style='font-size:xx-smaller; padding:3px;' class='button-move-right btn btn-xs btn-danger fa fa-chevron-right '></span>  </span> "
            //    + "<span class='column-controls'>  <span title='Select row container' class='design-square-row'>Select Row</span> <span title='Move column left' class='button-move-left btn btn-xs btn-danger fa fa-chevron-left ' style='font-size:xx-smaller; padding:3px;'>  </span> <span title='Move column right' style='font-size:xx-smaller; padding:3px;' class='button-move-right btn btn-xs btn-danger fa fa-chevron-right '></span> </span>"
