    ...
    (function (Page) {
        ...
        var PageElementBaseJQ = (function () {
            ...
            PageElementBaseJQ.prototype.AddRow = function (root, colClassNames, className, adjustRow, adjustColumn, beforeAfter) {
                ...
                jQuery(row).prepend("<span class=\"design-page-row \"> <span class='row-controls'> <span class='design-square-row'>Row</span> <span class='columns-add-text'> <button title='Add row up' class='jq-prev-row btn btn-xs btn-danger'> <span class='up fa fa-caret-square-o-up up-down-icons'></span> +</button> <button title='Add row down' class='jq-next-row btn btn-xs btn-danger'> <span class='down fa fa-caret-square-o-down'></span> +</button>  Columns <button title='Add column' class='jq-add-column btn btn-xs btn-danger'>+</button> <span class='button-move-left btn btn-xs btn-danger fa fa-chevron-left ' style='font-size:xx-smaller; padding:3px;'>  </span> <span style='font-size:xx-smaller; padding:3px;' class='button-move-right btn btn-xs btn-danger fa fa-chevron-right '></span> </span>  </span> <span class='image-text-other-controls'>  <span class='design-square-row'>Select Row</span>  <span class='design-square-column jq-select-column'>Select Column</span> <span class='button-move-left btn btn-xs btn-danger fa fa-chevron-left ' style='font-size:xx-smaller; padding:3px;'>  </span> <span style='font-size:xx-smaller; padding:3px;' class='button-move-right btn btn-xs btn-danger fa fa-chevron-right '></span> </span> </span>");
                if (row != undefined) {
