...
export module Font {
    ...
    export class FontJQ {
        ...
        public static ddnId = ".ddn-font-lists";
        ...
        public static LoadFontSize() {

            for (var i = 8; i <= 200; i++) {

                jQuery(".ddn-font-size").append(
                    "<option class='font-size-option selected' value='"
                    + i + "px" +
                    "'>"
                    + i +
                    "</option>");
        ...
        public static LoadFonts(ddnid?: string) {
            ...
            for (var i = 0; i < FontJQ.FontList.length; i++) {
                ...
                if (i == 0) {
                    jQuery(ddnid).append(
                        "<option class='font-list-option selected' value='"
                        + FontJQ.FontList[i] +
                        "'>"
                    ...
                    jQuery(ddnid).append(
                        "<option class='font-list-option' value='"
                        + FontJQ.FontList[i] +
                        "'>"
                        + "<span style='" + FontJQ.FontList[i] + "'>" + FontJQ.FontList[i] + "</span>" +
                        "</option>");
        ...
        public static PreviewInsertText() {
